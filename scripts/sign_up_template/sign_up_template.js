            ...
            <div class="Log-In-Field">
                ...
                <div class="Log-In-Form">
                    ...
                    <div class="email-password-alert-section">
                        ...
                        <span id="alertMessageName" class="alert-message hide-alert-message">
                    ...
                    <div class="email-password-alert-section">
                        ...
                        <div class="email-alert-messages">
                            <span id="alertMessageEmail" class="alert-message hide-alert-message">
                                Please enter a valid email address
                            </span>
                            <span id="alertMessageEmailExists" class="alert-message hide-alert-message">
                    ...
                    <div class="email-password-alert-section">
                        ...
                        <span id="alertMessageLength" class="alert-message hide-alert-message">
                    ...
                    <div class="email-password-alert-section">
                        ...
                        <span id="alertMessagePassword" class="alert-message hide-alert-message">
